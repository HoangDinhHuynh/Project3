import { Breadcrumb, Button, OrderItem, SelectQuantity } from 'component'
    ...
    <div className='w-full'>
      ...
      <div className='w-main mx-auto flex flex-col mb-12 justify-center items-end gap-3'>
        <span className='flex items-center gap-8 text-sm '>
          <span>Subtotal:</span>
          <span className='text-main font-bold'>{`${formatMoney(current?.cart?.reduce((sum,el)=> +el?.price + sum,0))} VNĐ`}</span>
        </span>
