...
const {RiTruckFill,FaShieldAlt,BsReplyFill,FaTty,AiFillGift} = icons
 export const productExtraInfomation = [
    ...
    {
        id:'2',
        tiltle: 'Free Shipping',
        sub:'Free On All Products',
        icon : <RiTruckFill/>
    },
    {
        id:'3',
        tiltle: 'Special Gift Cards',
 ...
 const {AiOutlineDashboard,MdGroups2,TbBrandProducthunt,RiBillLine} = icons
